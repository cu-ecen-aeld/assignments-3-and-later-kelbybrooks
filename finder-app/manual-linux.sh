...
cp ${FINDER_APP_DIR}/libc/lib/ld-linux-aarch64.so.1 lib
cp ${FINDER_APP_DIR}/libc/lib64/libm.so.6 lib64
cp ${FINDER_APP_DIR}/libc/lib64/libresolv.so.2 lib64
cp ${FINDER_APP_DIR}/libc/lib64/libc.so.6 lib64
